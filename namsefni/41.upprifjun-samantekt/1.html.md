...
- Skilgreina _hvernig_ HTML (og annað) á að virka
...
- Element gætu átt loka tag, t.d. `</p>`
...
Mikið af HTML elementum, flokkað:

- Flow elements, t.d. `<p>, <div>`
- Sectioning elements, t.d. `<header>, <nav>, <section>`
- Heading elements, `<h1>—<h6>`

---

- Phrasing elements, t.d. `<p>, <em>, <strong>`
- Embedded elements, t.d. `<img>, <video>, <audio>`
- Interactive elements, t.d. `<button>, <details>, <summary>`
